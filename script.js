    ...
    startOver() {
        ...
        this.chatMessages.innerHTML = `
            <div class="message bot-message">
                ...
                <div class="message-content">
                                                                    <p>Köszönöm az érdeklődését az XYZ Technology Kft-nél a <strong>Senior Frontend fejlesztő</strong> munkakörrel kapcsolatban. Szívesen végigvezetem a jelentkezési folyamaton, amely mindössze néhány percet vesz igénybe.</p>
